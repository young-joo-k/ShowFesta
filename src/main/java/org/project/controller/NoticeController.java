...
public class NoticeController {
	...
	/*
	 * @GetMapping("/notice_list") public void list(Model model, HttpSession
	 * session) { log.info("list Get");
	 * 
	 * String id = (String) session.getAttribute("id"); if (id != null) { MemberVO
	 * membervo = memberservice.getUserInfo(id); model.addAttribute("user",
	 * membervo); }
	 * 
