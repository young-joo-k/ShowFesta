				...
				<div class="cs-body">
					...
					<form role="form" action="contentsDelete" method="post" >
								    ...
								    <table class="contentList" style="border-collapse: collapse;">
								        ...
								        <c:forEach var="contents" items="${musicalContents}">
								            <tr class="allContentInfo">
								                <td class="checkBtn"><input type="checkbox" name="selectedcontents" value="${contents.m_num}"></td>
								                <td class="allContentInfoTitle"><c:out value="${contents.m_title}" /></td>
								                <td class="allContentInfo-startDate"><c:out value="${contents.m_start_date}" /></td>
								                <td class="allContentInfo-endDate"><c:out value="${contents.m_end_date}" /></td>
								                <td class="allContentInfo-place"><c:out value="${contents.m_place}" /></td>
								                <td class="allContentInfo-link"><c:out value="${contents.m_b_link}" /></td>
								            </tr>
								        </c:forEach>
								    </table>
						    	</c:otherwise>
						...
						<div class="register-btn-wrap">
							<ul>
								<li>
									<input type="submit" name="submitBtn" class="contentsDelete-submit"  value="삭제">
								</li>
								<li>
...
$(document).ready(function() {
    ...
    $('input[name="contentType"]').change(function() {
        ...
        $('.musicalContentList, .concertContentList').css('display', 'none');
        
        if (selectedType === "musical") {
            $('.musicalContentList').css('display', 'block');
        } else if (selectedType === "concert") {
            $('.concertContentList').css('display', 'block');
        }
    });
});
</script>
