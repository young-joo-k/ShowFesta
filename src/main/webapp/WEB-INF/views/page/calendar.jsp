								...
								<c:when test="${dateList.value=='today'}">
									<td class="today">
										...
										<div class="contentsCount">
											<a href="#" id = "m_btn${dateList.date }" class="contentsCnt1" data-event-type="뮤지컬"
												data-date="${dateList.date }">뮤지컬 :
												${dateList.musicalCnt}</a><br> 
											<a href="#" id = "c_btn${dateList.date }" class="contentsCnt2" data-event-type="콘서트"
												data-date="${dateList.date }">콘서트 :
												${dateList.concertCnt}</a><br>
											<a href="#" id = "f_btn${dateList.date }" class="contentsCnt3" data-event-type="축제"
												data-date="${dateList.date }">축제 :
												${dateList.festivalCnt}</a>
										</div>
										<c:forEach var="musicalList" items="${dateList.m_all_contents }">
										...
										<c:forEach var="concertList" items="${dateList.c_all_contents }">
										...
										<c:forEach var="festivalList" items="${dateList.f_all_contents }">
											<div class="festivalList${dateList.date }" style="display:none; ">
