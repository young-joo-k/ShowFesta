...
<div id="myPage-memberUpdate">
	<form id="myPage-memberUpdateForm" action="/page/memberUpdate" method="post">
			...
			<table class="myPage-member">
				<tbody class="myPage-edit-form">
					<tr class="myPage-member-info-wrap">
						...
						<td class="myPage-myInfo">${user.getId()} <!-- 						<span class = "myPage-member-info"></span> -->
...
<!-- 							<a href="#" onclick="userPw" class="phone-edit">비밀번호 변경하기</a> -->
							<input type="text" placeholder="비밀번호를 입력해 주세요." class="mypage-input-pw" id="myPage-user-pw" name="pw"
										maxlength="13" value="${user.getPw()}">
						</td>
					</tr>
					<tr class="myPage-member-info-wrap">
					...
					<tr class="myPage-member-info-wrap">
						...
						<td class="myPage-myInfo">
							<label for="user-phone"> 
								<input type="text" placeholder="전화번호를 입력해 주세요.(선택)" class="mypage-input-phone" id="myPage-user-phone" name="phone"
										maxlength="13" value="${user.getPhone()}">
							</label>
						</td>
					</tr>
					<tr class="myPage-member-info-wrap">
						...
						<td class="myPage-myInfo">
							<label for="user-phone"> 
								<input type="text" placeholder="이메일을 입력해 주세요.(선택)"
									class="mypage-input-email" id="myPage-user-email" name="email"
									maxlength="200" value="${user.getEmail() }">
							</label>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".correctBtn").click(function(e) {
			e.preventDefault();
			alert("수정이 완료되었습니다.");
			$("#myPage-memberUpdateForm").submit();
		});
	});
